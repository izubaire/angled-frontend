...
export default function Dashboard() {
  ...
  let currentlyWorkingEndpoint = `employments/?`;
  ...
  const handlePaginationChange = (event, value, name) => {
    ...
    if (name === "currentlyWorking") {
      ...
      //   fetchCurrentlyWorking(positionFilterEndpoint+filterValue+offsetEndpoint+offsetValue);
      // } else
    ...
    <Box sx={{ display: "flex" }}>
      ...
      >
        ...
        <Box component={Paper} sx={{ marginBottom: "20px", padding: "20px" }}>
          ...
          >
            <Stack spacing={2} direction="row" sx={{justifyContent:"space-between", flexWrap:"wrap", gap:"4"}} >
                <SelectOption
